...
![Decoder Waveform](image.png)

**Waveform Analysis:**
- **Time 0-10 ns:** A = "00" (00), EN = '1' → Y = "0001" (output 1 active)
- **Time 10-20 ns:** A = "01" (01), EN = '1' → Y = "0010" (output 2 active)
- **Time 20-30 ns:** A = "10" (10), EN = '1' → Y = "0100" (output 4 active)
- **Time 30-40 ns:** A = "11" (11), EN = '1' → Y = "1000" (output 8 active)
- **Final transition:** EN = '0' → Y = "0000" (all outputs disabled)

The waveform correctly demonstrates that each 2-bit input combination produces exactly one active output line, and when the enable signal is low, all outputs are disabled.
